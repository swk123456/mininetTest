...
def _timer_func():
    ...
    if turn == "0":
        ...
        print(getTheTime(), "sent the port stats request to s1_dpid, turn=0 output=5")
    ...
    if turn == "1":
        ...
        print(getTheTime(), "sent the port stats request to s1_dpid, turn=1 output=6")
    ...
    if turn == "2":
        ...
        print(getTheTime(), "sent the port stats request to s1_dpid, turn=2 output=4")
...
def _handle_portstats_received(event):
    ...
    print("port stats change connection dpid = ", event.connection.dpid)
